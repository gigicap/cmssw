...
process.spix = cms.Sequence(process.siPixelClusters * process.siPixelRecHits)
process.sstrip = cms.Sequence(process.siStripClusters * process.siStripMatchedRecHits)

process.slocal = cms.Sequence(process.sstrip * process.spix)

process.s = cms.Sequence(process.slocal + process.initialStepSeedsGigi + process.CAtracker)
