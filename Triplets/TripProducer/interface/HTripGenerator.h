#ifndef HTripGenerator_H
#define HTripGenerator_H
...
class HTripGenerator : public OrderedHitsGenerator {
 public:
 
   HTripGenerator(unsigned int size=500);
 
   virtual ~HTripGenerator() { }
