...
### Build seeds from pixel triplets (Gigi's Code)### 
### STEP 0 ###
...
# seeding layers (123 , 234) 
#initialStepSeedLayers = cms.ESProducer("SeedingLayersESProducer",
#    ComponentName = cms.string('initialStepSeedLayers'),
#    layerList = cms.vstring('BPix1+BPix2+BPix3','BPix2+BPix3+TIB1'),
#        BPix = cms.PSet(
#           useErrorsFromParam = cms.bool(True),
#           hitErrorRPhi = cms.double(0.0027),
#           TTRHBuilder = cms.string('TTRHBuilderWithoutAngle4PixelTriplets'),
...
initialStepSeedsGigi = RecoTracker.TkSeedGenerator.GlobalSeedsFromTriplets_cff.globalSeedsFromTriplets.clone(
...
initialStepSeedsGigi.OrderedHitsFactoryPSet.GeneratorPSet.SeedComparitorPSet.ComponentName = 'LowPtClusterShapeSeedComparitor'

initialStepSeedsGigi.OrderedHitsFactoryPSet.SeedingLayers = 'initialStepSeedLayers'

#SWITCHER
initialStepSeedsGigi.OrderedHitsFactoryPSet.GeneratorPSet = cms.PSet(TripGenerator)
#initialStepSeedsGigi.OrderedHitsFactoryPSet.GeneratorPSet = cms.PSet(PixelTripletHLTGenerator)
...
initialStepTrackCandidates = RecoTracker.CkfPattern.CkfTrackCandidates_cfi.ckfTrackCandidates.clone(
     src = cms.InputTag('initialStepSeedsGigi'),
...
initialStepSelector = RecoTracker.FinalTrackSelectors.multiTrackSelector_cfi.multiTrackSelector.clone(
 ...
 # Final sequence
InitialStepGigiTrip = cms.Sequence(initialStepSeedsGigi*
